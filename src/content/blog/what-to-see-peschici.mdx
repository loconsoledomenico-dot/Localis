...
The [audio story The North Coast — Trabucchi, Villages and Sea](/en/guide/gargano-nord/) is built on that *why*: it doesn't list the stops, it tells them, while you walk. It doesn't replace the visit — it gives it a backdrop.
