"""
Generatore guide audio DE — ElevenLabs — Valle d'Itria (nuove 3 guide)
Voci DE assegnate:
  ostuni-de     → George   JBFqnCBsd6RMkjVDRZzb  (british warm — vigile)
  cisternino-de → Brian    nPczCjzI2devNBz1zQrb  (deep american — macellaio)
  fasano-de     → Charlie  IKne3meq5aSn9XLyUdCD  (energetico — parapendio)
"""
import re
import sys
import time
...
GUIDES = [
    ("ostuni-de",     "JBFqnCBsd6RMkjVDRZzb"),   # George — british warm
    ("cisternino-de", "nPczCjzI2devNBz1zQrb"),   # Brian — deep american
    ("fasano-de",     "IKne3meq5aSn9XLyUdCD"),   # Charlie — energetico
]
