"""
Generatore guide audio EN — Fish Audio s2 — Valle d'Itria (nuove 3 guide)
Voci EN assegnate:
  ostuni-en     → Ferdinando  536d3a5e000945adb7038665781a4aca  (warm maturo)
  cisternino-en → Antonello   d8f13232599c4f60b5df3232ddededca  (pratico diretto)
  fasano-en     → Nathan      9b20d81c64fd48448ee90da70f236d0e  (narrativo)
"""
import re
import sys
import time
...
GUIDES = [
    ("ostuni-en",     "536d3a5e000945adb7038665781a4aca"),   # Ferdinando
    ("cisternino-en", "d8f13232599c4f60b5df3232ddededca"),   # Antonello
    ("fasano-en",     "9b20d81c64fd48448ee90da70f236d0e"),   # Nathan
]
